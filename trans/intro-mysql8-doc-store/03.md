...
在本章中，我们更详细地探讨了 JSON 数据类型。我们看到了如何通过 MySQL 中提供的大量内置 JSON 函数来处理关系表中的 JSON 数据的例子。JSON 数据类型是允许用户开发跨越 SQL 和 NoSQL 应用程序的混合解决方案的关键。

在第 4 章中，我将更详细地探索 MySQL Shell，包括介绍如何使用 MySQL Shell 开发您的应用程序。
