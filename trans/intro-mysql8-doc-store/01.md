...
如果你在想，“是时候了！”Oracle 开发了新的 MySQL 客户端，你并不孤单。MySQL Shell 代表了一种大胆的与 MySQL 交互的新方式。有许多选项，甚至有不同的方式来配置和使用 shell。虽然我们将在第 4 章中看到更多关于 shell 的内容，但是让我们看看如何使用 shell 来执行前面显示的查询。图 [1-1](#Fig1) 显示了新 MySQL Shell的快照。请注意，它提供了一个非常熟悉的界面，尽管更现代、更强大。
