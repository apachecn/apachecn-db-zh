...
![Figure 6.1: Updating using pipeline support ](image/B15507_06_01.jpg)
...
![Figure 6.2: Updating value of an array field ](image/B15507_06_02.jpg)
...
![Figure 6.3: Removing an array field ](image/B15507_06_03.jpg)
...
1.  To insert a single document, add the following command:
    ...
    ![Figure 6.4: Adding one element into an array ](image/B15507_06_04.jpg)
...
2.  As shown here, the **genre** array field is created successfully, and the given element is added to the array. Now add one more genre, as follows:
    ...
    ![Figure 6.5: Adding another element into the array ](image/B15507_06_05.jpg)
...
![Figure 6.6: Pushing multiple elements into an array ](image/B15507_06_06.jpg)
...
![Figure 6.7: Sorting an array ](image/B15507_06_07.jpg)
...
![Figure 6.8: Sorting an array and pushing elements into it ](image/B15507_06_08.jpg)
...
![Figure 6.9: Sorting an array based on a value of a nested field ](image/B15507_06_09.jpg)
...
![Figure 6.10: Adding element into an array as a set ](image/B15507_06_10.jpg)
...
![Figure 6.11: Adding multiple elements into an array as a set ](image/B15507_06_11.jpg)
...
5.  Now, open a MongoDB shell and connect to the Mongo Atlas cluster, and then go to the **sample_mflix** database. Execute the preceding command on the database. The output should be as follows:
    ...
    ![Figure 6.12: Adding the new genre ](image/B15507_06_12.jpg)
...
6.  To verify this, write a **find** query using the same condition and project the essential fields with the following command:
    ...
    ![Figure 6.13: Output showing the movies belonging to the Classic genre ](image/B15507_06_13.jpg)
...
![Figure 6.14: Removing the last element from an array ](image/B15507_06_14.jpg)
...
![Figure 6.15: Removing the first element from an array ](image/B15507_06_15.jpg)
...
![Figure 6.16: Removing all elements of an array ](image/B15507_06_16.jpg)
...
![Figure 6.17: Removing elements that matched the given regular expression ](image/B15507_06_17.jpg)
...
![Figure 6.18: Replacing all elements from an array ](image/B15507_06_18.jpg)
...
![Figure 6.19: Replacing elements that match given filters ](image/B15507_06_19.jpg)
...
6.  Now, open the mongo shell and connect to the MongoDB Atlas cluster. Use the database of **sample_mflix** and execute the preceding command.
    ...
    ![Figure 6.20: Updating the name of the director ](image/B15507_06_20.jpg)
...
7.  Now, find the director's movies with his full name using a regular expression in the **directors** field:
    ...
    ![Figure 6.21: Output showing the director's correct name ](image/B15507_06_21.jpg)
...
![Figure 6.22: Showing only casts of the movie ](image/B15507_06_22.jpg)
