...
![Figure 3.1: Diagrammatic representation of an IP address ](image/B15507_03_01.jpg)
...
![Figure 3.2: Netmask and its CIDR notation ](image/B15507_03_02.jpg)
...
![Figure 3.3: Private IP addresses for IP4 ](image/B15507_03_03.jpg)
...
![Figure 3.4: Encapsulated Wire Protocol datagrams ](image/B15507_03_04.jpg)
...
![Figure 3.5: MongoDB Atlas console ](image/B15507_03_05.jpg)
...
![Figure 3.6: Adding an IP address list ](image/B15507_03_06.jpg)

图 3.6：添加 IP 地址列表

当您点击**添加 IP 地址**按钮（或**+添加 IP 地址**时，会出现一个弹出窗口：

![Figure 3.7: Adding a new IP access list entry ](image/B15507_03_07.jpg)
...
![Figure 3.8: Filling in the Comment field in the IP Access list entry  ](image/B15507_03_08.jpg)
...
![Figure 3.9: Adding a temporary IP Access list entry ](image/B15507_03_09.jpg)

图 3.9：添加临时 IP 访问列表条目

当您点击**确认**时，IP/主机地址保存在访问列表中，网络配置被激活。流程通常在不到一分钟内完成，在此期间，进入状态将为**待定**几秒钟，如*图 3.10*所示：

![Figure 3.10: Network access window displaying the Pending status ](image/B15507_03_10.jpg)

图 3.10：显示挂起状态的网络访问窗口

一旦网络配置被激活，**状态**将变为**激活**，如*图 3.11*所示：

![Figure 3.11: Network Access window ](image/B15507_03_11.jpg)
...
2.  Log on to your new MongoDB Atlas web interface using your username and password, which was created when you registered for the Atlas Cloud:
    ...
    ![Figure 3.12: MongoDB Atlas login page  ](image/B15507_03_12.jpg)

    图 3.12:MongoDB Atlas 登录页面

3.  From the **SECURITY** menu, click the **Network Access** tab:

    ![Figure 3.13: Network Access window ](image/B15507_03_13.jpg)
...
5.  From the **Add IP Access List Entry** window that appears, click the **ADD CURRENT IP ADDRESS** button:
    ...
    ![Figure 3.14: IP Access list window ](image/B15507_03_07.jpg)
...
6.  Type **This is my IP Address** in the **Comment** field (this is optional):
    ...
    ![Figure 3.15: Typing in a comment in the Add IP Access List Entry window ](image/B15507_03_08.jpg)
...
8.  The IP address will appear in the access list table (as active):
    ...
    ![Figure 3.16: Network Access window ](image/B15507_03_11.jpg)
...
![Figure 3.17: Database Access window ](image/B15507_03_17.jpg)

图 3.17：数据库访问窗口

在*图 3.17*中，您会注意到两个选项卡，**数据库用户**和**自定义角色**。让我们首先关注**数据库用户**的可用选项。单击**添加新数据库用户**选项创建新用户后，将出现以下窗口：

![Figure 3.18: Add New Database User window ](image/B15507_03_18.jpg)
...
![Figure 3.19: Username and password fields in the Add New Database User window ](image/B15507_03_19.jpg)
...
![Figure 3.20: Temporary User option in the Add New User window ](image/B15507_03_20.jpg)
...
![Figure 3.21: The Database Access window ](image/B15507_03_21.jpg)
...
![Figure 3.22: Pictorial representation of database privileges ](image/B15507_03_22.jpg)
...
![Figure 3.23: Add New Database User window ](image/B15507_03_23.jpg)

图 3.23：添加新数据库用户窗口

默认情况下，窗口中会自动选择内置的**读写任意数据库**角色，如*图 3.23*所示。但是，管理员可以通过点击下拉菜单来分配不同的角色（例如，**Atlas admin**，如*图 3.24*所示：

![Figure 3.24: Selecting a role in the Add New User window ](image/B15507_03_24.jpg)
...
![Figure 3.25: Granting specific privileges in the Add New User window ](image/B15507_03_25.jpg)
...
2.  From the **SECURITY** menu, select the **Database Access** option:
    ...
    ![Figure 3.26: Selecting the Database Access option ](image/B15507_03_26.jpg)
...
6.  Provide the password or click **Autogenerate Secure Password** to generate the password. Click **SHOW** to see the autogenerated password:
    ...
    ![Figure 3.27: Add New Database User window ](image/B15507_03_27.jpg)
...
8.  Click **Add User**. The system will apply the changes to the databases:
    ...
    ![Figure 3.28: New admin user details ](image/B15507_03_28.jpg)
...
![Figure 3.29: MongoDB custom roles ](image/B15507_03_29.jpg)
...
![Figure 3.30: Custom role list ](image/B15507_03_30.jpg)
...
![Figure 3.31: Elements of the connection string ](image/B15507_03_31.jpg)
...
1.  Log on to your new MongoDB Atlas web interface using your username and password, which was created when you registered for the Atlas Cloud:
    ...
    ![Figure 3.32: MongoDB Atlas login page ](image/B15507_03_32.jpg)
...
3.  Click on the **CONNECT** button in the **Clusters** menu. In the case of M0 free-tier, there is a single cluster called **Cluster0**:
    ...
    ![Figure 3.33: Clusters window ](image/B15507_03_33.jpg)

    图 3.33：集群窗口

4.  The **Connect to Cluster0** window appears:

    ![Figure 3.34: Connect to Cluster0 window ](image/B15507_03_34.jpg)

    图 3.34：连接到 Cluster0 窗口

5.  Click **Connect with the mongo shell**. The following window appears:

    ![Figure 3.35: Connect to Cluster0 page ](image/B15507_03_35.jpg)
...
![Figure 3.36: MongoDB Compass connected to Atlas cloud ](image/B15507_03_36.jpg)
...
![Figure 3.37: Logical structure of MongoDB ](image/B15507_03_37.jpg)
...
7.  Query the view, as follows:
    ...
    ![Figure 3.38: Session output ](image/B15507_03_38.jpg)
...
![Figure 3.39: Connecting the MongoDB Shell ](image/B15507_03_39.jpg)
