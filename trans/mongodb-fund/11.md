...
![Figure 11.1: Contents of output.json file (truncated) ](image/B15507_11_01.jpg)
...
7.  With your command complete, copy it from your **Exercise11.01.txt** file into your terminal or command prompt to run it:
    ...
    ![Figure 11.2: Contents of the action_movies.json file (truncated for brevity) ](image/B15507_11_02.jpg)
...
14.  Check the two new collections in MongoDB by running the following command:
    ...
    ![Figure 11.3: Displaying the new collections ](image/B15507_11_03.jpg)
...
4.  Finally, to automatically place your dump file in a **.gz** file, use the **--gzip** parameter and run the command.
    ...
    ![Figure 11.4: Output after the mongodump command is executed ](image/B15507_11_04.jpg)
...
![Figure 11.5: Output after mongorestore is run using the –drop option ](image/B15507_11_05.jpg)
...
![Figure 11.6 Output from the mongodump command ](image/B15507_11_06.jpg)

图 11.6 mongodump 命令的输出

**mongorestore**命令的输出开始如下所示：

![Figure 11.7: Start of the output from the mongorestore command ](image/B15507_11_07.jpg)

图 11.7:mongorestore 命令输出的开始

**mongorestore**命令的输出结束如下：

![Figure 11.8: End of the output from the mongorestore command ](image/B15507_11_08.jpg)
