...
*第 6 章**使用聚合管道和阵列*进行更新，涵盖了更复杂的更新操作，使用管道和批量更新。
...
![Figure 0.1: Output as a figure ](image/B15507_Preface_01.jpg)
...
2.  The website should detect your operating system and present you with a button that allows the direct download of a stable build. Of course, you can choose a different version by clicking the down arrow for additional options:
    ...
    ![Figure 0.2: Download prompt for Visual Studio Code ](image/B15507_Preface_02.jpg)
...
![Figure 0.3: Installed versions of Node.js and npm ](image/B15507_Preface_03.jpg)
