...
3.  Click on **Validate JSON** to validate the code. The following screenshot displays the expected output and validity of the JSON document:
    ...
    ![Figure 2.1: The JSON document and its validity check ](image/B15507_02_01.jpg)
...
![Figure 2.2: The movies table ](image/B15507_02_02.jpg)
...
![Figure 2.3: Result for imdb_ratings for the movies collection ](image/B15507_02_03.jpg)
...
![Figure 2.4: Output for the plainNum, explicitInt, and explicitInt_double ](image/B15507_02_04.jpg)
...
![Figure 2.5: MongoDB shell output ](image/B15507_02_05.jpg)
...
![Figure 2.6: Output for explicitDecimal and explicitDecimal_double ](image/B15507_02_06.jpg)
...
![Figure 2.7: Output for dec and decDbl ](image/B15507_02_07.jpg)
...
![Figure 2.8: Output for the embedded object ](image/B15507_02_08.jpg)
...
6.  Finally, validate your document with any online JSON validator (in our case, [https://jsonlint.com/](https://jsonlint.com/)). Click on **Validate JSON** to validate the code:
    ...
    ![Figure 2.9: Validation of the JSON document ](image/B15507_02_09.jpg)
...
4.  Now, validate the JSON document with an online validator (for example, [https://jsonlint.com/](https://jsonlint.com/)). Click **Validate JSON** to validate the code:
    ...
    ![Figure 2.10: Validation of the JSON document ](image/B15507_02_10.jpg)
...
![Figure 2.11: Binary array ](image/B15507_02_11.jpg)
...
1.  Visit [https://cloud.mongodb.com/](https://cloud.mongodb.com/) and click to log in to your account:
    ...
    ![Figure 2.12: Atlas login page ](image/B15507_02_12.jpg)

    图 2.12:Atlas 登录页面

    由于您已经在云上创建了一个集群，因此登录后，将出现以下显示集群详细信息的屏幕：

    ![Figure 2.13: Cluster view ](image/B15507_02_13.jpg)
...
2.  Click on the (**…**) option available next to **COLLECTIONS**. A drop-down list displaying the following options will appear. Click **Load Sample Dataset**:
    ...
    ![Figure 2.14: The Load Sample Dataset option ](image/B15507_02_14.jpg)

    图 2.14：加载样本数据集选项

    这将打开一个确认对话框，其中显示将加载到集群中的样本数据集的总大小：

    ![Figure 2.15: Load Sample Dataset confirmation ](image/B15507_02_15.jpg)

    图 2.15：加载样本数据集确认

3.  Click **Load Sample Dataset**. You will see a message saying **Loading your sample dataset...** on the screen:

    ![Figure 2.16: Loading your sample dataset… window ](image/B15507_02_16.jpg)
...
4.  Once the dataset has successfully loaded, you will see a success message saying **Sample dataset successfully loaded**:
    ...
    ![Figure 2.17: Sample dataset successfully loaded ](image/B15507_02_17.jpg)
...
5.  Now, click **COLLECTIONS**. On the next screen, you will see the following list of available databases:
    ...
    ![Figure 2.18: List of sample databases ](image/B15507_02_18.jpg)
...
7.  Select the **movies** collection.
    ...
    ![Figure 2.19: Movies collection on the cluster ](image/B15507_02_19.jpg)
...
![Figure 2.20: Sample tweet ](image/B15507_02_20.jpg)
