...
![Browsing data without transformations](graphics/7782_16_01.jpg)
...
![Configuring settings for MIME columns](graphics/7782_16_02.jpg)
...
![Browser transformations](graphics/7782_16_03.jpg)
...
![Configuring GD2 library availability verification](graphics/7782_16_04.jpg)
...
![Clickable thumbnail (JPEG or PNG)](graphics/7782_16_05.jpg)
...
![Clickable thumbnail (JPEG or PNG)](graphics/7782_16_06.jpg)
...
对于`.png`文件，我们必须在**MIME 类型**对话框中使用**image/png**，在**浏览转换**对话框中使用**image/png:inline**。

## 向图像添加链接

为了提供没有缩略图的链接，我们使用了**image/jpeg:link**转换。没有转换选项。此链接可用于查看照片（通过左键单击链接），然后可能会下载照片（通过右键单击照片本身）。

![Adding links to an image](graphics/7782_16_07.jpg)
...
![Date formatting](graphics/7782_16_08.jpg)
...
![Date formatting](graphics/7782_16_09.jpg)
...
![text/plain: link](graphics/7782_16_10.jpg)
...
![text/plain: imagelink](graphics/7782_16_11.jpg)

在这种情况下，我们可以切换到**全文**来显示完整的链接。然后我们可以看到完整的图像。

![text/plain: imagelink](graphics/7782_16_12.jpg)

其他转换，如 `image/jpeg: inline`和 `image/png: inline`指定图像的确切 MIME 类型。在这些情况下，phpMyAdmin 使用 GD2 库函数生成缩略图。然而， `text/plain: imagelink`转换中包含的链接可能引用任何浏览器支持的图像类型。因此，phpMyAdmin 只显示一个调整大小的图像，其中包含一个 HTML `img`标记，以及根据转换中定义的大小选项设置的 `width`和 `height`属性。要查看原始图像，我们可以单击链接或缩略图。
...
![Preserving the original formatting](graphics/7782_16_13.jpg)
...
![Displaying a download link](graphics/7782_16_14.jpg)
...
![Hexadecimal representation](graphics/7782_16_15.jpg)
...
![External application example: In-cell sort](graphics/7782_16_16.jpg)

这里的**‘0’**是指 `sort`的索引号，**'-r’**是 `sort`的参数，使得程序按相反的顺序排序。

接下来，我们编辑《百年电影（第一卷）》一书的行，输入一些没有特定顺序的关键字（如以下截图所示），点击**Go**以保存更改：

![External application example: In-cell sort](graphics/7782_16_17.jpg)

为了测试外部程序的效果，我们浏览表格并查看已排序的单元格内关键字：

![External application example: In-cell sort](graphics/7782_16_18.jpg)
